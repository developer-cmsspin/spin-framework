...
module.exports = (env) => {
	// Start::config env
	let file = env.production == true ? './webpack.config/env/env.prod.js' : `./webpack.config/env/env.${Appsettings.Enviroment}.js`;
		...
		return {
			...
			resolve: {
				...
				alias: {
					...
					'jquery-validation': Path.resolve(__dirname, 'node_modules/jquery-validation/dist/jquery.validate.min.js'),
